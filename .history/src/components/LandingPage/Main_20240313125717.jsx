...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-full w-full flex-col  place-content-center px-4">
      ...
      {/* Content */}
      <div className="z-10 mx-auto flex w-full max-w-[1080px] flex-col space-y- text-white">
        <h1 className="flex  flex-col space-y-1 text-3xl font-bold sm:text-5xl xl:text-6xl">
          {hero_content?.title &&
