    ...
    <header className="z-20 text-white bg-white bg-opacity-5">
      ...
      <nav className="mx-auto flex max-w-7xl flex-row items-center justify-between p-4">
        ...
        <div className="flex flex-row space-x-8 transition">
          ...
          <div className=''>
        {/* Not signed in <br /> */}
        <button onClick={() => signIn('google')} className='cursor-pointer rounded-lg bg-white bg-opacity-20 px-6 py-3 font-medium text-white hover:bg-opacity-50'>Sign in</button>
      </div>
        </div>
      </nav>
    </header>
