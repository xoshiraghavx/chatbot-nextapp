  ...
  return (
    <section className="relative flex min-h-full w-full flex-col  place-content-center px-4">
      ...
      <div className="absolute right-0 hidden min-h-full  w-1/4 flex-col justify-center lg:flex">
        {/* Circle */}
        <div className=" -left-full aspect-square h-[26rem] rounded-full lg:-left-1/2">
          {/* pop buttons */}
          <div className=" -top-2 -left-[55%]">
            <svg
              viewBox="0 0 139 76"
              fill="none"
          ...
          <div className=" -top-2 -left-2 flex cursor-pointer flex-col rounded-xl bg-white bg-opacity-60 backdrop-blur	 px-8 py-6 text-center transition hover:-translate-y-1 hover:shadow-md z-10">
