...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-full w-full flex-col  place-content-center px-4">
      {/* Patterns */}
      <div className="absolute right-0 hidden min-h-full w-1/4 flex-col justify-center bg-white lg:flex">
        {/* right patterns */}
        ...
        <div className="absolute -left-full aspect-square h-[26rem] rounded-full bg-gradient-to-b from-yellow-100 to-amber-300 lg:-left-1/2">
          ...
          <div className="absolute bottom-4 -left-1/4 z-10 flex cursor-pointer flex-row items-center space-x-4 rounded-xl bg-ECE2DF px-4 py-2 text-center shadow transition hover:-translate-y-1 hover:shadow-md">
      ...
      <div className="z-10 mx-auto flex w-full max-w-[1080px] flex-col space-y-8">
        ...
        <div className="flex flex-row items-center space-x-10 transition">
          ...
          <button onClick={() => signIn('google')} className='rounded-lg bg-red-300 px-8 py-4 font-bold text-black hover:bg-red-300/80'>Get Started</button>
