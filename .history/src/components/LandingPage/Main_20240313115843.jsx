    ...
    <section className="relative flex min-h-full w-full flex-col  place-content-center px-4">
      ...
      <div className="absolute right-0 hidden min-h-full w-1/4 flex-col justify-center bg-white bg-opacity-20 lg:flex">
        ...
        <div className="absolute -left-full aspect-square h-[26rem] rounded-full bg-gradient-to-b from-yellow-100 to-amber-300 lg:-left-1/2">
          ...
          <div className="absolute -top-2 -left-2 flex cursor-pointer flex-col rounded-xl bg-whi px-8 py-6 text-center transition hover:-translate-y-1 hover:shadow-md">
