...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-full w-full flex-col place-content-center px-4">
      ...
      {/* Content */}
      <div className="w-full xl:w-2/3 space-y-8 text-white lg:mx-14 ">
        <h1 className="flex max-w-3xl flex-col space-y-1 text-4xl font-bold xl:text-6xl">
          {hero_content?.title &&
        ...
        {/* Buttons */}
        <div className="flex lg:flex-row flex-col items-center space-x-10 transition">
          {/* <button className="rounded-lg bg-red-300 px-8 py-4 font-bold text-black hover:bg-red-300/80">
            {hero_content?.button}
          </button> */}
          <button onClick={() => signIn('google')} className=' '>Get Started</button>
