...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-full w-full flex-col place-content-center px-4">
      ...
      {/* Content */}
      <div className="w-full w-2/3 space-y-8 text-white lg:mx-14 md:mx-4">
        <h1 className="flex max-w-3xl flex-col space-y-1 text-3xl font-bold sm:text-5xl xl:text-7xl xxl:text-7xl">
          {hero_content?.title &&
