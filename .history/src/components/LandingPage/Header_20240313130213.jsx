...
export default function Header() {
  ...
  return (
    <header className="z-20 text-white bg-white bg-opacity-5">
      {/* Nav Bar */}
      <nav className="mx-auto flex max-w-8xl flex-row items-center justify-between p-4">
        {/* Logo */}
        ...
        <div className="flex flex-row space-x-8 transition">
          ...
          <div className=''>
        {/* Not signed in <br /> */}
        <button onClick={() => signIn('google')} className='cursor-pointer rounded-lg bg-white bg-opacity-20 px-6 py-4 font-medium text-white hover:bg-gray-800'>Sign in</button>
      </div>
        </div>
      </nav>
    </header>
