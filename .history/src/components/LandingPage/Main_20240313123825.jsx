    ...
    <section className="relative flex min-h-full w-full flex-col  place-content-center px-4">
      ...
      <div className="absolute right-0 hidden min-h-full w-1/4 flex-col justify-center bg-white bg-opacity-20 lg:flex">
        ...
        <div className="absolute -left-full aspect-square h-[26rem] rounded-full lg:-left-1/2">
          ...
          <div className="absolute -top-2 -left-2 flex cursor-pointer flex-col rounded-xl bg-white bg-opacity-90 px-8 py-6 text-center transition hover:-translate-y-1 hover:shadow-md z-10">
            <span className="text-4xl font-bold text-black">6k</span>
            <span className="text-base text-gray-800">Clients</span>
          </div>

          <div className="absolute bottom-4 -left-1/4 z-10 flex cursor-pointer flex-row items-center space-x-4 rounded-xl  bg-white bg-opacity-40 backdrop-blur	 px-4 py-2 text-center shadow transition hover:-translate-y-1 hover:shadow-md">
          ...
          <div className="absolute bottom-1/4 -right-16 z-10 flex cursor-pointer flex-col rounded-xl  bg-white bg-opacity-90 px-10 py-4 text-center transition hover:-translate-y-1 hover:shadow-md xl:-right-1/4">
