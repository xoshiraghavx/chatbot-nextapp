...
export default function Hero() {
  const hero_content = {
    title: ["Enter the World of Smart Conversations:", "Intelligent Interaction Simplified"],
    description:
  ...
  return (
    <section className="relative flex min-h-full w-full flex-col  place-content-center px-4">
      ...
      <div className="z-10 mx-auto flex w-full max-w-[1080px] flex-col space-y-8 text-white">
        <h1 className="flex max-w-2xl flex-col space-y-1 text-3xl font-bold sm:text-5xl xl:text-5xl">
          {hero_content?.title &&
