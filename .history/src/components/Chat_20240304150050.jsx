    ...
    return (
        <div>
            ...
            </div>
            {
                ...
                <ul className='bg-gray-100 w-auto mx-6 lg:w-1/2 p-5   rounded-lg'>{messages.map((m, index) => (
            ...
            '>
                <form onSubmit={handleSubmit}>
                    ...
                    <input type='text' placeholder='Chat here ....'
                        ...
                        className='border border-black border-2 w-56 lg:w-96 h-96 p-2 rounded-md'
                    />
